				...
				<div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-md">
					...
					<form onSubmit={handleSubmit}>
						...
						<div className="mb-4">
							...
							<input type="text" id="title" name="title" value={post.title} onChange={handleChange} placeholder="Enter post title"
							className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
						</div>

						<div className="mb-4">
							<label htmlFor="body" className="block text-gray-700 font-medium mb-2">Title</label>
							<textarea id="body" name="body" value={post.body} onChange={handleChange} placeholder="Enter post content"
							className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" rows={4}/>
						</div>
